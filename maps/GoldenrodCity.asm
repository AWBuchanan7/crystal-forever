...
GoldenrodCity_MapEvents:
	...
	warp_event 30, 15, GOLDENROD_CINEMA, 1

	def_coord_events

	def_bg_events
	bg_event 12, 14, BGEVENT_READ, GoldenrodCityStationSign
	bg_event  6, 17, BGEVENT_READ, GoldenrodCityRadioTowerSign
	...
	bg_event 32, 16, BGEVENT_READ, GoldenrodCinemaSign

	def_object_events
	object_event  8, 18, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event 18, 10, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityLassScript, EVENT_GOLDENROD_CITY_CIVILIANS
