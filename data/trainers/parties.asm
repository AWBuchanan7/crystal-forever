...
CooltrainerMGroup:
	...
	db 67, SANDSLASH, SCOPE_LENS, SANDSTORM, EARTHQUAKE, HYPER_BEAM, SLASH
	db 67, KABUTOPS, LEFTOVERS, GIGA_DRAIN, ANCIENTPOWER, BLIZZARD, ICY_WIND
	db 67, SCYTHER, NO_ITEM, PURSUIT, FOCUS_ENERGY, FURY_CUTTER, SEISMIC_TOSS
	db 67, SNEASEL, KINGS_ROCK, PSYBEAM, SLASH, LEECH_LIFE, REST
	db 67, PORYGON, NO_ITEM, PSYCHIC, TRI_ATTACK, RECOVER, ZAP_CANNON
	db -1 ; end
...
CooltrainerFGroup:
	...
	; COOLTRAINERF (22)
	db "AUBREY@", TRAINERTYPE_ITEM_MOVES
	db 67, OCTILLERY, NO_ITEM,   	 OCTAZOOKA, FOCUS_ENERGY, ICE_BEAM, TOXIC
	db 67, GOLBAT,    KINGS_ROCK,    GIGA_DRAIN, CONFUSE_RAY, WING_ATTACK, STEEL_WING
	db 67, HAUNTER,   LEFTOVERS,     HYPNOSIS, CURSE, SHADOW_BALL, THUNDER
	db 68, PARASECT,  SCOPE_LENS,    PSYBEAM, SLASH, LEECH_LIFE, REST
	db -1 ; end
...
BeautyGroup:
	...
	; BEAUTY (18)
	db "MCKAYLA@", TRAINERTYPE_ITEM_MOVES
	db 67, DRAGONAIR, NO_ITEM, OUTRAGE, FIRE_BLAST, ICE_BEAM, THUNDERBOLT
	db 67, RAPIDASH, KINGS_ROCK, FIRE_SPIN, FIRE_BLAST, HYPNOSIS, NIGHTMARE
	db 67, WOOPER, NO_ITEM, EARTHQUAKE, MUD_SLAP, SLUDGE_BOMB, ANCIENTPOWER
	db 67, NOCTOWL, LEFTOVERS, REST, STEEL_WING, SKY_ATTACK, MIRROR_MOVE
	db 67, PORYGON2, SCOPE_LENS, PSYBEAM, TRI_ATTACK, RECOVER, THUNDER
	db -1 ; end
