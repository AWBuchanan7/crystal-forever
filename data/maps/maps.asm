...
MapGroup_ViridianForest:
	map ViridianForest, TILESET_KANTO_FOREST, ROUTE, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND

MapGroup_CeruleanBikeShop:
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_GoldenrodCinema:
	map GoldenrodCinema, TILESET_GAME_CORNER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GAME_CORNER, FALSE, PALETTE_DAY, FISHGROUP_POND
