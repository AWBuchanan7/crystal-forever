...
MapGroup_ViridianForest:
	map ViridianForest, TILESET_KANTO_FOREST, ROUTE, ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND

MapGroup_CeruleanBikeShop:
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_GoldenrodCinema:
	map GoldenrodCinema, TILESET_GAME_CORNER, INDOOR, GOLDENROD_CITY, MUSIC_GAME_CORNER, FALSE, PALETTE_DAY, FISHGROUP_POND

MapGroup_UnknownDungeon:
	map UnknownDungeon1F, TILESET_DARK_CAVE, DUNGEON, CERULEAN_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map UnknownDungeon1FSage, TILESET_DARK_CAVE, INDOOR, CERULEAN_CITY, MUSIC_MT_MOON_SQUARE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map UnknownDungeon2F, TILESET_DARK_CAVE, DUNGEON, CERULEAN_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE