...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_SCOTT2
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_AUBREY
; ExecutiveF
...
; ALTERED
	const EVENT_VIRIDIAN_FOREST_SCOPE_LENS
	const EVENT_GOT_SKATEBOARD
	const EVENT_GOLDENROD_CINEMA_DOORMAN
	const EVENT_GOLDENROD_CINEMA_CONCESSIONS
	const EVENT_BEAT_BEAUTY_MCKAYLA
	const EVENT_UNKNOWN_DUNGEON_SAGE_SHOPKEEP
	const EVENT_FOUND_ULTRA_BALL_A_IN_UD1F
	const EVENT_FOUND_ULTRA_BALL_B_IN_UD1F
	const EVENT_FOUND_PP_UP_IN_UD1F
	const EVENT_FOUND_RARE_CANDY_IN_UD1F
	const EVENT_FOUND_MAX_REVIVE_IN_UD1F
	const EVENT_FOUND_TM_EARTHQUAKE_IN_UD1F
	const EVENT_FOUND_TM_NIGHTMARE_IN_UD1F
	const EVENT_UNKNOWN_DUNGEON_2F_DRAGONBREATH_NIDOQUEEN
	const EVENT_FOUGHT_DRAGONBREATHNIDOQUEEN_IN_UD2F
